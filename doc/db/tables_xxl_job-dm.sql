...
(
    "ID" BIGINT IDENTITY(129,1) NOT NULL,
    "JOB_GROUP" INT NOT NULL,
    "JOB_ID" INT NOT NULL,
...
(
    "ID" INT IDENTITY(2026,1) NOT NULL,
...
ALTER TABLE "XXL_JOB_GROUP" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "XXL_JOB_INFO" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "XXL_JOB_LOCK" ADD CONSTRAINT  PRIMARY KEY("LOCK_NAME") ;

ALTER TABLE "XXL_JOB_LOG" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "XXL_JOB_LOGGLUE" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "XXL_JOB_LOG_REPORT" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "XXL_JOB_REGISTRY" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "XXL_JOB_USER" ADD CONSTRAINT  PRIMARY KEY("ID") ;
